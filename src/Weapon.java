/**
 * Une arme permet au personnage d'infliger des dÍgats aux autres personnages
 * elle fait un certain nombre de dÈgats et possÈde un nom.
 */
public class Weapon {
	...
	/**
	 * Une arme par defaut. Cette épée de bois fait 10 de dÈgats.
	 */
	public Weapon() {
